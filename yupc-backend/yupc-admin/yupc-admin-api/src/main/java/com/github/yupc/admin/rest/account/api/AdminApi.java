...
import com.github.yupc.admin.rest.account.api.hystrix.AdminApiHystrix;
 ...
 */
@FeignClient(name = "${yupc.feign-server.gateway:yupc-gateway-server}", fallback = AdminApiHystrix.class)
