package com.github.yupc.admin.rest.authority.api;

import com.github.pagehelper.PageInfo;
import com.github.yupc.admin.rest.authority.api.hystrix.AdminRoleApiHystrix;
 ...
 */
@FeignClient(name = "${yupc.feign-server.gateway:yupc-gateway-server}", fallback = AdminRoleApiHystrix.class)
