package com.github.yupc.admin.config.datasource;


import com.github.yupc.admin.configuration.AdminDataSourceProperties;
import com.github.yupc.core.spring.autoconfigure.datasource.DataSourceFactory;
...
@MapperScan(
        basePackages = {
                "com.github.yupc.admin.repository.account.dao",
                "com.github.yupc.admin.repository.authority.dao",
        },
...
public class AdminAutoConfiguration {
    ...
    private static final String AOP_POINTCUT_EXPRESSION = "execution (* com.github.yupc.admin.impl..impl.*.*(..))";
