package com.github.yupc.gateway.filter;

import com.github.yupc.gateway.config.GateIgnoreProperties;
import com.github.yupc.gateway.feign.LogService;
...
public class AdminAccessFilter extends ZuulFilter {
    ...
    @PostConstruct
    public void init() {
        //InstanceInfo prodSvcInfo = discoveryClient.getNextServerFromEureka("yupc-ADMIN-SERVER", false);
